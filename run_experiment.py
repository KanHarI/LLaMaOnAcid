...
def main():
    ...
    parser = argparse.ArgumentParser(description="LLaMa on Acid: Simulating psychedelic effects on LLMs")
    ...
    parser.add_argument("--dmn-file", type=str, default=None,
                       help="Path to pre-identified DMN file (if available)")
    ...
    parser.add_argument("--factors", type=float, nargs="*", default=[0.0, 0.3, 0.5, 0.7, 0.9],
