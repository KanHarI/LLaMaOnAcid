...
from ..config import CACHE_DIR, FALLBACK_ARTICLES, CACHE_TTL_DAYS
...
def fetch_top_wikipedia_articles(
    ...
    cache_file = os.path.join(wiki_cache_dir, "top_articles.json")
    ...
    if use_cache and not force_refresh and os.path.exists(cache_file):
        try:
            ...
            if cache_age <= CACHE_TTL_DAYS["articles"]:
                ...
                print(f"Cached article list is {cache_age} days old (> {CACHE_TTL_DAYS['articles']}), fetching new data")
        ...
        try:
            ...
            if cache_timestamp:
                ...
                if cache_age <= CACHE_TTL_DAYS["content"]:
                    ...
                    print(f"Cached content for '{article_title}' is {cache_age} days old (> {CACHE_TTL_DAYS['content']})")
        except Exception as e:
