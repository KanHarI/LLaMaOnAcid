        ...
        try:
            ...
            if "chunks" in cached_data and "articles" in cached_data:
                ...
                if current_articles.issubset(cached_articles):
                    ...
                    print(
                        f"Articles list changed. Cached: {len(cached_articles)}, Current: {len(current_articles)}"
                    )
                    print(
                        f"Will fetch content for {len(current_articles - cached_articles)} new articles"
                    )
